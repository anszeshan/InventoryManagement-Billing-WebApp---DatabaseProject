...
-- SELECT TransactionID, SUM(Amount) as Amount, TransactionDate, TransactionTime
-- FROM ordersdb
-- GROUP BY TransactionID, TransactionDate, TransactionTime
SELECT TransactionID, SUM(Amount) as Amount, MAX(TransactionDate) as TransactionDate, TransactionTime
FROM ordersdb
GROUP BY TransactionID, TransactionTime;
